...
- Place cursor tip at center of element
- Adjust click location if initial click fails

**Actions:** left_click, right_click, double_click, type, screenshot, wait, scroll, key, left_click_drag, zoom, scroll_to, hover
